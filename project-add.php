...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
      <div class="col-md-4">
      <img src="images/addproduct.png" style="max-width: 100%; height: auto;">
         </div>
      <div class="col-md-8">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="number" step="0.01" min="0" max="99999999" id="product_price" name="product_price"class="form-control" placeholder="0.00" required>
              </div>
              <div class="form-group">
