      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a href="productgridview.php" class="btn btn-warning btn"><b> > Switch to Grid View</b></a> 
          </div>
          <div class="col-sm-6">
                  ...
                  <tbody>
                      ...
                      while ($res = mysqli_fetch_assoc($result)) {
                        ...
                        <div class="button-container">
                            <button class="btn btn-warning" onclick="location.href=\'edit_product.php?id=' . $res['product_id'] . '\'">
                                <i class="fas fa-edit"></i> Edit
                            </button>
                            <button class="btn btn-danger" onclick="if (confirm(\'Are you sure you want to delete?\')) { location.href=\'remove-product.php?id=' . $res['product_id'] . '\'; }">
