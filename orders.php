          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="delete_history.php" class="btn btn-primary float-right"><b> <i class="fas fa-trash-alt"></i> View Delete History</b></a> 
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                    ...
                    while ($res = mysqli_fetch_assoc($result)) {
                      ...
                      echo '<td>
                        <div class="button-container">
                          <button class="btn btn-warning" onclick="location.href=\'edit_order.php?id=' . $res['order_id'] . '\'">
                            <i class="fas fa-edit"></i> Edit
                          </button>
                          <button class="btn btn-danger" onclick="if (confirm(\'Are you sure you want to delete?\')) { location.href=\'remove-order.php?id=' . $res['order_id'] . '\'; }">
